...
const data_skjutningar_2021 = [22, 14, 21, 21, 36, 34, 35, 43, 28, 40, 27, 9];
const data_avlidna_2021 = [2, 3, 1, 3, 9, 3, 4, 10, 2, 4, 3, 0];
const data_skadade_2021 = [8, 7, 2, 8, 4, 11, 12, 13, 12, 16, 10, 6];
...
export const data_detonationer_2021 = [9, 5, 9, 8, 11, 6, 3, 5, 8, 6, 5, 4];
export const data_forberedelse_2021 = [3, 7, 9, 5, 5, 4, 6, 7, 6, 6, 4, 5];
export const data_forsok_2021 = [0, 2, 0, 2, 2, 0, 1, 0, 0, 0, 3, 0];
