...
const data_skjutningar_2021 = [22, 14, 21, 21, 35, 34, 35, 41, 27, 37, 0, 0];
const data_avlidna_2021 = [2, 3, 1, 3, 9, 3, 4, 10, 3, 4, 0, 0];
const data_skadade_2021 = [8, 7, 2, 8, 4, 11, 12, 13, 12, 16, 0, 0];
...
export const data_detonationer_2021 = [9, 5, 9, 8, 11, 6, 3, 5, 8, 6, 0, 0];
export const data_forberedelse_2021 = [3, 7, 9, 5, 5, 4, 6, 7, 6, 6, 0, 0];
